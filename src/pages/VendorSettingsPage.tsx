          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  value={profile?.his_email || ''}
                  readOnly
                  className="w-full pr-10 px-3 py-2 border rounded-md bg-gray-50"
                  dir="ltr"
                />
              </div>
              <p className="mt-1 text-sm text-gray-500">{t.emailReadOnlyHint || 'Email cannot be changed.'}</p>
            </div>
